...
author: 'Avantika Diwadkar (avantika.diwadkar@pennmedicine.upenn.edu) and Nisha Narayanan (nisha.narayanan@pennmedicine.upenn.edu'
...
Get pre-generated raster layer for a given pollutant for a month or year in 1997 to 2021
```{r eval=T, echo=T,warning=FALSE,message=FALSE}
...
Get pre-generated raster layer for a given pollutant for a month or year in 1997 to 2021 specifically for Puerto Rico.
...
Get estimate of a given pollutant for a given year (1997 to 2021). Derived from annual EPA files.
```{r eval=T, echo=T,warning=FALSE,message=FALSE}
res_lst <- list()
for (i in seq(1,nrow(res_df))){
